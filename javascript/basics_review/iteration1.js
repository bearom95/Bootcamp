...
const movies = [
    {title: 'Madagascar', duration: 192, categories: ['comedia', 'aventura']},
...
for (let movie of movies) {
    for (let category of movie.categories) {         //meterse de nuevo en cada elemento del array categories
        if (categoriasTotales.includes(category) == false) {
            categoriasTotales.push(category)
        }
    }
}
